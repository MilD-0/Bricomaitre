...
function getProductUrl(locale: Locale, token: string) {
...
export function buildProductMetadata(product: Product, locale: Locale): Metadata {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...Object.fromEntries(
          locales.map((entry) => [entry, getProductUrl(entry, product.canonicalToken)]),
        ),
  ...
  return [
    {
      ...
      offers: {
        ...
        seller: {
          '@id': `${getStorefrontSiteUrl()}/#organization`,
