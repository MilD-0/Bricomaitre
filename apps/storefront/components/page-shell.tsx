      ...
      {contactSettings.aiAssistantEnabled ? (
        <ShoppingAssistantLauncher
          ...
          labels={{
            ...
            toolActivity: {
              read_storefront_guidance: assistant('toolReadGuidance'),
              search_catalog: assistant('toolSearchCatalog'),
              inspect_products: assistant('toolInspectProducts'),
              inspect_order: assistant('toolInspectOrder'),
              inspect_delivery_support: assistant('toolInspectDeliverySupport'),
              inspect_promotion: assistant('toolInspectPromotion'),
              manage_cart: assistant('toolManageCart'),
              present_products: assistant('toolPresentProducts'),
            },
            toolFailed: assistant('toolFailed'),
            ...
            cartUpdated: assistant('cartUpdated'),
