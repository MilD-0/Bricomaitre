...
function Skeleton({ className = '', ...props }: SkeletonProps) {
  return (
    <span aria-hidden="true" {...props} className={`storefront-skeleton ${className}`.trim()} />
  );
}
...
function SkeletonShell({ children, page }: { children: ReactNode; page: string }) {
  return (
    <div
      className="site-shell storefront-skeleton-shell"
    ...
    >
      ...
      <footer className="storefront-skeleton-footer">
        <Skeleton />
        <Skeleton />
        <Skeleton />
      </footer>
...
export function CatalogCardSkeleton() {
  return (
    <article className="catalog-card catalog-card-skeleton" aria-hidden="true">
      ...
      <div className="catalog-card-skeleton-body">
        <Skeleton />
        <Skeleton />
        <Skeleton />
        <Skeleton />
  ...
  return (
    <SkeletonShell page="home">
      <div className="home-page home-page-skeleton">
        ...
        <div className="home-skeleton-trust">
          <Skeleton />
          <Skeleton />
          <Skeleton />
        </div>
    ...
    <SkeletonShell page="catalog">
      <div className="catalog-loading" aria-hidden="true">
        ...
        <div className="catalog-skeleton-layout">
          ...
          <section>
            <div className="catalog-skeleton-toolbar">
              <Skeleton />
              <Skeleton />
            </div>
  ...
  return (
    <SkeletonShell page="product">
      <div className="product-page-loading" aria-hidden="true">
        ...
        <div className="product-skeleton-layout">
          <Skeleton className="product-skeleton-media" />
          <section className="product-skeleton-summary">
            <Skeleton />
            <Skeleton />
            <Skeleton />
            <Skeleton />
        ...
        <section className="product-skeleton-similar">
          <Skeleton />
          <div className="catalog-grid">
            {Array.from({ length: 4 }, (_, index) => (
              <CatalogCardSkeleton key={index} />
...
export function CheckoutContentSkeleton() {
  return (
    <div
      className="checkout-page checkout-page-skeleton"
      aria-busy="true"
      aria-label="Loading checkout"
    >
      <Skeleton className="checkout-skeleton-heading" />
      <div className="checkout-layout">
        <section className="checkout-form-panel">
          {Array.from({ length: 7 }, (_, index) => (
            <Skeleton key={index} className="checkout-skeleton-field" />
          ))}
        </section>
...
export function ThankYouContentSkeleton() {
  return (
    <div
      className="thank-you-page thank-you-page-skeleton"
      aria-busy="true"
      aria-label="Loading order confirmation"
    >
      <section className="thank-you-skeleton-hero">
        <Skeleton />
        <div>
          <Skeleton />
          <Skeleton />
...
export function SimilarProductsSkeleton() {
  return (
    <section className="similar-products similar-products-skeleton" aria-hidden="true">
      <Skeleton />
...
export function SearchResultsSkeleton() {
  return (
    <ul className="global-search-skeleton" aria-hidden="true">
