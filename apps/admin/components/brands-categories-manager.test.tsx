...
describe('BrandsCategoriesManager', () => {
  ...
  it('supports popup create flow for brands on the brands page', async () => {
    ...
    await userEvent.type(
      within(brandDialog).getByRole('textbox', { name: 'Image' }),
      'https://cdn.example.com/nova.jpg',
    );
  ...
  it('supports creating brands without an uploaded image', async () => {
    ...
    const brandDialog = screen.getByRole('dialog');
    await userEvent.type(
      within(brandDialog).getByRole('textbox', { name: 'Name' }),
      'No Image Brand',
    );
    await userEvent.click(within(brandDialog).getByRole('button', { name: 'New brand' }));
  ...
  it('supports popup create flow for categories on the categories page', async () => {
    ...
    await userEvent.type(
      within(categoryDialog).getByRole('textbox', { name: 'Arabic name' }),
      'مواد مانعة للتسرب',
    );
  ...
  it('supports popup edit flow for categories on the categories page', async () => {
    ...
    await userEvent.type(
      within(categoryDialog).getByRole('textbox', { name: 'Name' }),
      'Exterior paint',
    );
    ...
    await userEvent.selectOptions(
      within(categoryDialog).getByRole('combobox', { name: 'Parent category' }),
      '3',
    );
  ...
  it('persists brand dialog draft state across refresh on the brands page', async () => {
    ...
    await userEvent.type(
      within(firstDialog).getByRole('textbox', { name: 'Image' }),
      'https://cdn.example.com/draft.jpg',
    );
    ...
    expect(within(restoredDialog).getByRole('textbox', { name: 'Name' })).toHaveValue(
      'Draft brand',
    );
    expect(within(restoredDialog).getByRole('textbox', { name: 'Image' })).toHaveValue(
      'https://cdn.example.com/draft.jpg',
    );
  });
