...
import { chartTooltip, DenseTable, MetricStrip, Section } from '../analytics-workspace-primitives';
import { SearchOpportunity, SearchPage, type useSearchVisibilityView } from './use-search';

export function SearchVisibilityViewView({
  data,
  copy,
  locale,
  sync,
  ...
  setSelectedPage,
  inspectionIssues,
}: NonNullable<ReturnType<typeof useSearchVisibilityView>['view']>) {
  return (
    <>
