...
import { OrderProductThumbnail, type useOrderEditorBody } from './use-editor';

export function OrderEditorBodyView({
  dirty,
  valid,
  writable,
  pending,
  ...
  deliveryFee,
  total,
}: NonNullable<ReturnType<typeof useOrderEditorBody>['view']>) {
  return (
    <form
      onSubmit={(event) => {
