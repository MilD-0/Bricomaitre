...
/* eslint-disable @next/next/no-img-element -- Admin asset previews may use blob URLs and configured arbitrary origins that Next Image cannot optimize safely. */
