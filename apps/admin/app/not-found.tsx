      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-5xl items-center justify-center">
        <section className="w-full overflow-hidden rounded-[var(--shape-radius-hero)] border border-white/10 bg-[var(--glass-surface)] p-6 shadow-[var(--shadow-vapor-strong)] backdrop-blur-xl md:p-10">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex rounded-full border border-sky-400/25 bg-sky-400/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[var(--type-tracking-p240)] text-sky-200">
              {copy.badge}
            </div>
          ...
          <div className="mt-10 grid gap-3 md:grid-cols-3">
            <div className="rounded-[var(--shape-radius-overlay)] border border-white/8 bg-black/15 p-4 text-left">
              <p className="text-xs font-semibold uppercase tracking-[var(--type-tracking-p200)] text-slate-400">
                01
              </p>
              <p className="mt-2 text-sm font-medium text-slate-100">Navigation guardrails</p>
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Use the sidebar sections that match your role and environment permissions.
              </p>
            </div>
            <div className="rounded-[var(--shape-radius-overlay)] border border-white/8 bg-black/15 p-4 text-left">
              <p className="text-xs font-semibold uppercase tracking-[var(--type-tracking-p200)] text-slate-400">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Jump back into catalog or dashboard flows without losing context.
              </p>
            </div>
            <div className="rounded-[var(--shape-radius-overlay)] border border-white/8 bg-black/15 p-4 text-left">
              <p className="text-xs font-semibold uppercase tracking-[var(--type-tracking-p200)] text-slate-400">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Metadata is locked to no-index defaults so the admin app stays out of search
                results.
              </p>
            </div>
          </div>
