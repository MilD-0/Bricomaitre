...
const CIRCLE_VARIANTS: Variants = {
  normal: {
    translateY: 0,
    opacity: 1,
    transition: { opacity: { duration: 0.2 }, type: "spring", stiffness: 150, damping: 15, bounce: 0.8 },
  },
  animate: {
    opacity: [0, 1],
    translateY: [-20, 0],
...
const SECOND_CIRCLE_VARIANTS: Variants = {
  normal: {
    translateY: 0,
    opacity: 1,
    transition: { opacity: { duration: 0.2 }, delay: 0.15, type: "spring", stiffness: 150, damping: 15, bounce: 0.8 },
  },
  animate: {
    opacity: [0, 1],
    translateY: [-20, 0],
