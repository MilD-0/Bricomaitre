...
export function resolveCategorySlug(slug: string, loadMeta: typeof getStorefrontCatalogMeta = getStorefrontCatalogMeta) {
  return resolveTaxonomy(slug, (meta) => meta.categories, loadMeta);
}

export function resolveBrandSlug(slug: string, loadMeta: typeof getStorefrontCatalogMeta = getStorefrontCatalogMeta) {
