...
const product = {
  ...
  media: [],
  brand: null,
  category: { id: 3, name: 'Lighting', nameAr: 'الإضاءة', slug: 'lighting', image: null, parentId: null, properties: [] },
...
describe('product presentation', () => {
  it('selects complete Arabic copy and falls back field by field', () => {
    ...
    expect(getLocalizedProductCopy({ ...product, titleAr: ' ', descriptionAr: null }, 'ar')).toMatchObject({
      title: 'Lampe de travail',
      description: 'Éclairage stable',
    });
  });
