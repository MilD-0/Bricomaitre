...
test('serves crawl policy, merchant identity, and API-backed localized product discovery', async ({ page, request }) => {
  ...
  expect(robots).toContain('Disallow: /fr/collections/');
  ...
  for (const path of ['/favicon.ico', '/icon.png', '/apple-icon.png', '/icons/icon-192.png', '/icons/icon-maskable-512.png']) {
