...
The shared carrier client owns request validation, rate-limit interpretation, pacing, shipment operations, labels, and tracking. Admin owns provider selection and the operational workflow around it.
