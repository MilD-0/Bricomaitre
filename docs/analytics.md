...
| -------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Orders                           | Submitted demand, Confirmation Status, captured line prices, discounts, delivery fees, and purchase costs |
...
evidence but do not silently replace the planning assumption. Paid economics
do not apply the planning return rate a second time.
