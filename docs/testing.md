...
Use [task environments and verification](development.md) for a source-bound local
stack, recorded checks, cross-service diagnostics, and the connected checkout-to-carrier journey.
