...
resume an investigation and inspect what supported an earlier answer. Saved
tool evidence is restored within a bounded model-context budget; persistence
does not require resending an unlimited transcript to the provider.
