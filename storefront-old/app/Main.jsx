      ...
      <Layout className="lg:drop-shadow-lg ">
        <div className="mt-8 md:mb-16">
          <div className="mt-8 overflow-hidden">
            {featureds ? (
              featureds.length > 1 ? (              <Slider {...settings}>
                {(locale === "ar" ? [...featureds].reverse() : featureds).map(
                  (featured) => (
                    <div
                      key={featured._id}
                      className="lg:h-[52em]    min-h-52 "
                    >
                      ...
                      className="lg:h-[52em]    min-h-52 "
                    >
                      <Link className=" mb-1" href={featureds[0].link}>
                        <Image
                          src={featureds[0].image}
                          quality={50}
                          width={5000}
                          height={5000}
                          alt="featured"
