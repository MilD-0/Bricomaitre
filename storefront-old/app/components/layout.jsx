...
export default function Layout({ children }) {
  ...
  return (
    <div className="">
      ...
      >
        ...
        >
            ...
            <div className="align-middle text-end  gap-2  -mt-8 flex ">
              <div className="flex md:justify-center mx-auto me-2 md:me-auto  bg-green-500 text-gray-100 rounded-full font-medium  px-1.5 pt-1 align-middle">
                <div className="md:hidden  animate-[pulse_4s_ease-in-out_infinite] me-0">
                  {" "}
                  <Link dir="ltr" href={`tel:0795 34 28 26`}>
                    <svg
          ...
          <div className="relative ">
            ...
            {pathname !== "/products" && results.length > 0 && (
      ...
      {!pathname.includes("/cart") && cartProducts?.length > 0 && (
        <Link
          href="/cart"
          className="fixed bottom-36 right-4 z-50 group bg-white hover:text-white hover:bg-teal-600 text-black ring-1 ring-black p-3 rounded-full shadow-xl transition-all duration-300 flex items-center gap-2 animate-fade-in hover:scale-105"
          style={{
