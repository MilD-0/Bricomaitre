    ...
    <div>
      <div className="lg:hidden">
        <Layout>
          ...
          {product.stock > 0 && <div className=" w-full   flex flex-col justify-between  mt-10">
            <Link
              href="#order1"
            ...
            {product.OldPrice && (
              <span className="font-bold text-center text-red-500 block text-2xl mt-1">
          ...
          {product.stock > 0 ? (<div className="p-4 px-2 mt-10" id="order1">
            <OrderForm prod={id} cart={false} modify={false}></OrderForm>
          </div>): <div className=" m-5 text-center text-lg text-red-500">{t("ns")}</div>}
        ...
        <Layout>
          <div className="grid grid-cols-2 gap-3 p-4  ">
            ...
            <div className="col-span-2 mt-4 " id="order2">
             {product.stock > 0 && <div className="w-[90%] p-4 justify-center mx-auto border-2 border-black rounded-2xl bg-white ">
