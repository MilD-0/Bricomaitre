...
The demo runs on my own machine and may be slow or offline; AI availability varies.
[Run it locally](./docs/demo.md#run-it-locally) or [email me](mailto:mayldsauce@gmail.com) to arrange access.
...
For an isolated worktree with all apps, workers, local dependencies, and recorded
verification, follow the [task development workflow](./docs/development.md).
