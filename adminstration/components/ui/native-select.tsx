...
export function NativeSelectOption({ children, ...props }: React.OptionHTMLAttributes<HTMLOptionElement>) {
  return <option {...props}>{children}</option>;
}

export function NativeSelectOptGroup({ children, ...props }: React.OptgroupHTMLAttributes<HTMLOptGroupElement>) {
