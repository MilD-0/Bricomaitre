...
describe('app/api/brands/route', () => {
  ...
  it('returns paginated brands from the dedicated route', async () => {
    readBrandsPageMock.mockResolvedValue({
      items: [{ id: '1', name: 'Acme', slug: 'acme', image: null, isActive: true, status: 'active', createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-01-02T00:00:00.000Z', createdBy: null, createdByName: null, updatedBy: null, updatedByName: null }],
      pagination: { page: 2, limit: 50, totalItems: 60, totalPages: 2, hasNextPage: false, hasPreviousPage: true },
    });
