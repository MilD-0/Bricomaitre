...
export default defineConfig({
  resolve: {
    ...
    alias: [
      ...
      { find: '@bric/storefront-core/meta-contracts', replacement: `${rootDir}/../packages/storefront-core/src/storefront/meta-contracts.ts` },
      { find: '@bric/storefront-core/meta', replacement: `${rootDir}/../packages/storefront-core/src/storefront/meta.ts` },
