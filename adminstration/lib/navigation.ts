...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { key: 'landingPages', href: '/stats/landing-pages', translationKey: 'statsDashboard.tabs.landingPages' },
      { key: 'aiAssistants', href: '/stats/ai-assistants', translationKey: 'statsDashboard.tabs.aiAssistants' },
      { key: 'customers', href: '/stats/customers', translationKey: 'statsDashboard.tabs.customers' },
